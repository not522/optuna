...
nitpick_ignore = [
    ...
    ('py:class', 'optuna.pruners.Hyperband'),
    ('py:class', 'optuna.struct.StudySummary'),
    ...
    ('py:class', 'optuna.trial.FronzenTrial'),
    ('py:class', 'optuna.storage'),
    ...
    ('py:obj', 'TrialState.WAITING'),
    ('py:obj', 'optuna.optimize'),
    ...
    ('py:class', 'optuna.integration.NSGAIISampler'),
]
